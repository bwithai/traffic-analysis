...
from optflow import CoordinatesTransformation
...
from yolov7_helper.models.experimental import attempt_load
from yolov7_helper.utils.general import check_img_size
from yolov7_helper.utils.torch_utils import TracedModel, load_classifier, select_device

model = torch.hub.load("WongKinYiu/yolov7", "custom", args.model)
class Detector:
